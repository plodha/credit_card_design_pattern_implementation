...
public class CreditCardIntro {
	...
	public static void main(String[] args) {
		...
		if(input.contains(".csv")) {
			...
			Cards = csv(input);
			writerStatus = writeCSV(Cards, MCH);
		}
		...
		// JSON File
			...
			Cards = json(input);
			writerStatus = writeJSON(Cards, MCH);
		...
		// XML File
			...
			Cards = xml(input);
			writerStatus = writeXML(Cards, MCH);
	...
	public static boolean writeCSV(ArrayList<CreditCard> Cards, MasterCardHandler MCH) {
	...
	public static boolean writeJSON(ArrayList<CreditCard> Cards, MasterCardHandler MCH) {
		try {
	...
	public static boolean writeXML(ArrayList<CreditCard> Cards, MasterCardHandler MCH) {
